import{a as d,i as N,S as E,A as j,R as H,b as A,N as I,P as C,c as V}from"./assets/vendor-zibWxtCk.js";(function(){const t=document.createElement("link").relList;if(t&&t.supports&&t.supports("modulepreload"))return;for(const s of document.querySelectorAll('link[rel="modulepreload"]'))o(s);new MutationObserver(s=>{for(const n of s)if(n.type==="childList")for(const i of n.addedNodes)i.tagName==="LINK"&&i.rel==="modulepreload"&&o(i)}).observe(document,{childList:!0,subtree:!0});function a(s){const n={};return s.integrity&&(n.integrity=s.integrity),s.referrerPolicy&&(n.referrerPolicy=s.referrerPolicy),s.crossOrigin==="use-credentials"?n.credentials="include":s.crossOrigin==="anonymous"?n.credentials="omit":n.credentials="same-origin",n}function o(s){if(s.ep)return;s.ep=!0;const n=a(s);fetch(s.href,n)}})();d.defaults.baseURL="https://paw-hut.b.goit.study/api";async function G(){return(await d.get("/categories")).data}async function U(e,t,a){let o=e?{page:t,limit:a,categoryId:e}:{page:t,limit:a};return(await d.get("/animals",{params:o})).data}function _(e){let t="Виникла невідома помилка";switch(e){case 400:t="Неправильний запит";break;case 403:t="Немає авторизован";break;case 404:t="Не існує ресурсу";break;case 500:t="Проблеми з сервером";break;case 502:t="Поганий шлюз";break;case 503:t="Сервіс на разі недоступний";break;case 504:t="Час очікування вичерпано";break}N.error({title:"Помилка",message:t,position:"topRight",theme:"dark",backgroundColor:"#ef4040"})}async function z(e){return(await d.post("https://paw-hut.b.goit.study/api/orders",e)).data}const S=document.querySelector(".modalCloseButton");function J(e){const t=document.getElementById("form-backdrop");if(!t)return;const a=t.querySelector("form");a&&(a.dataset.animalId=e,t.classList.remove("is-hidden"),document.body.classList.add("modal-open"),a.addEventListener("submit",async o=>{var n,i;if(o.preventDefault(),!a.reportValidity())return;const s={name:a.name.value.trim(),phone:a.tel.value.trim(),animalId:a.dataset.animalId,comment:a.comment.value.trim()};try{await z(s),console.log(s),E.fire({icon:"success",title:"Успіх!",text:"Ваша заявка відправлена."}),y()}catch(F){E.fire({icon:"error",title:"Помилка",text:((i=(n=F.response)==null?void 0:n.data)==null?void 0:i.message)||"Помилка при відправленні заявки"})}},{once:!0}))}function y(){const e=document.getElementById("form-backdrop");if(!e)return;const t=e.querySelector("form");t&&t.reset(),e.classList.add("is-hidden"),document.body.classList.remove("modal-open")}S&&S.addEventListener("click",y);document.addEventListener("click",e=>{const t=document.getElementById("form-backdrop");t&&e.target===t&&y()});document.addEventListener("keydown",e=>{const t=document.getElementById("form-backdrop");t&&e.key==="Escape"&&!t.classList.contains("is-hidden")&&y()});const r={backdrop:document.querySelector("#animal-modal-backdrop"),modalContent:document.querySelector("#modal-content"),closeBtn:document.querySelector("#modal-close")};function K(e){return`
  ...
  `}function W(e){if(!r.backdrop||!r.modalContent)return;r.modalContent.innerHTML=K(e),r.backdrop.classList.remove("is-hidden"),document.body.classList.add("modal-open");const t=r.modalContent.querySelector(".btn-adopt");t&&t.addEventListener("click",()=>{const a=t.dataset.animalId;J(a),b()}),window.addEventListener("keydown",B)}function b(){r.backdrop.classList.add("is-hidden"),document.body.classList.remove("modal-open"),window.removeEventListener("keydown",B)}function B(e){e.code==="Escape"&&b()}var P;(P=r.closeBtn)==null||P.addEventListener("click",b);var M;(M=r.backdrop)==null||M.addEventListener("click",e=>{e.target===r.backdrop&&b()});function Q(e){return g.find(t=>t._id===e)}let g=[],p="all",f=1,h,q=X();function X(){return window.innerWidth>=1440?9:8}const v=document.querySelector(".our-pets-categories");v.addEventListener("click",ee);async function Y(){try{const e=await G();Z(e)}catch(e){_(e.status)}}function Z(e){let t=e.map(a=>`<li class="our-pets-category-item">
      ...
      </li>`+t}function ee(e){if(e.target.dataset.id!==p&&e.target.closest("button")){let t=v.querySelector(".active");t&&t.classList.remove("active"),p=e.target.dataset.id,e.target.classList.add("active"),k()}}const L=document.querySelector(".our-pets-list");async function k(e=!1){T(),D(),e||(L.innerHTML="",f=1);const t=p==="all"?"":p;try{const a=await U(t,f,q);h=Math.ceil(a.totalItems/q),te(a.animals),O(),e?g.push(...a.animals):g=a.animals}catch(a){_(a.status)}finally{oe()}}L.addEventListener("click",e=>{const t=e.target.closest(".pets-btn");if(!t)return;const a=t.dataset.id,o=Q(a);o&&W(o)});function te(e){let t=e.map(a=>{let o=a.categories.map(s=>`<li class="pets-category"><p>${s.name}</p></li>`).join("");return`      <li class="our-pets-item">
        <img
          class="pets-img"
          src="${a.image}"
          alt="${a.species}"
